...
public class Principal extends JFrame implements ActionListener{
    ...
    Welcome ventanaBienvenida = new Welcome();
      ...
      mb = new JMenuBar();
      mb.setBackground(new Color(10, 0, 10));
      setJMenuBar(mb);
    ...
    //   ImageIcon imagen = new ImageIcon("C:/Users/USER/Desktop/ALL COURSE/TECNOLOGIA/java course/Saicol Dev/imagenes/imagenprotada2.png");
    //   labelLogo = new JLabel(imagen);  
    //   labelLogo.setBounds(5,5,250,100);
    //   add(labelLogo);

      labelBienvenido = new JLabel("Bienvenido " + nombreAdministrador);  
      labelBienvenido.setBounds(225,30,300,50);
      ...
      labelfooter = new JLabel("\u00B02022 Saicol Dev - Saicol Tech -- Consulta todos tus datos");
